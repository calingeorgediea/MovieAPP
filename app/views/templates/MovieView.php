        ...
        if ($data->Image) { ?>
                    ...
                    <div class="col-sm">
                        ...
                        <div id="movie-description">
                            ...
                            <strong> Genre </strong>
                            <p>
                                <?php echo $data->GenreName ?>
                            </p>
                            <strong> IMDB rating </strong>
                            <p>
                                <?php echo $data->API_movie_rating ?>
                            </p>
                            <strong> Relase Year </strong>
                            <p>
                                <?php echo $data->relase_date ?>
                            </p>
                            <?php } else { ?>
                            <p>
                                <button onclick='imdbUpdate("<?php echo $data->MovieTitle; ?>")' type="submit"
                                    id="delete" class="btn btn-danger">Synchronise with IMDb</button>
                                <?php } ?>
                            </p>
                            <strong> Description </strong>
                            <p>
                                <?php echo $data->MovieDescription ?>
                            </p>
                        </div>
                    </div>
                    <div class="col-8">
